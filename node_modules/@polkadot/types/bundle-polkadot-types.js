const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p({}, location), xcm), v0$1), v1$1), v2), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
  ...
  const definitions$a = {
    rpc: {},
    types: _objectSpread$n(_objectSpread$n(_objectSpread$n({}, v0), v1), {}, {
      // latest mappings
      SiField: 'Si1Field',
