  ...
  class Decorate extends Events {
    ...
    _decorateStorageEntry(creator, decorateMethod) {
      ...
      decorated.at = decorateMethod((hash, ...args) => from(this.at(hash)).pipe(switchMap(api => {
        util.assert(api.rx.query[creator.section] && api.rx.query[creator.section][creator.method], () => `query.${creator.section}.${creator.method} is not available in this version of the metadata`);
